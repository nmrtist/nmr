...
use crate::processing::methods::baseline::*;
...
const _: () = {
    ...
    impl Codec for BaselineEstimate {
        fn to_wire<'a>(&'a self, budget: &mut Budget<'_, '_>) -> Result<Value<'a>, SnapshotError> {
            record(
                "processing_baseline.BaselineEstimate.v1",
                vec![
        ...
        fn from_wire(
            ...
            let mut f = fields(node, "processing_baseline.BaselineEstimate.v1", 4)?;
